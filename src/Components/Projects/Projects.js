...
import NewBegining from "../../assets/NewBegining.jpg";
...
function handleChurchClick() {
  window.open("https://newbeginningsministries.net/")
}

function handleCalcLiveCode() {
  window.open("https://okjos.github.io/Calculator/")
}

function handleCalcCodeClick() {
  window.open("https://github.com/OKjos/Calculator")
}
    ...
    <div className="projects-container" id="projects">
      ...
      <div className='project-grid'>
        ...
        <div>
          ...
          <div className='tools'>
            <h1>Calculator</h1>
            <h2>Calculator made with JS and a little bit of css.</h2>
            <button className='Calc-live' onClick={handleCalcLiveCode}>Live Demo</button>
            <button className='Calc-code' onClick={handleCalcCodeClick}>Code</button>
            </div>
          </div>
          <div>
          <div className='content'>
          ...
          <div className='tools'>
            <h1>WebSite</h1>
            <h2>A local church asked for a simple website.</h2>
            <button className='Church-live' onClick={handleChurchClick}>WebSite Link</button>
            </div>
          </div>
      </div>
    </div>
